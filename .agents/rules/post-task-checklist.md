---
always_on: true
description: "Mandatory 7-Step Post-Task Documentation & Hygiene Protocol enforced after testing"
---

# Mandatory Post-Task Documentation & Hygiene Protocol

Whenever implementing features, resolving bugs, or refactoring code, after running tests and verification, **ALWAYS** execute this 7-point checklist before concluding:
...
### 5. 🏛️ Architecture Decision Records (ADRs)
...
### 6. 🎯 Git Issues & Ambiguity Tracking

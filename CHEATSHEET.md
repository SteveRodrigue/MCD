...
_Use when adding, auditing, or refining any player or encounter card._
...
_Use when parsing raw printed card text into valid declarative JSON or auditing existing card mappings._
...
> ```
>
> _Parses Peter Parker (01001b), breaks down matched tokens, flags any unmatched text, validates schema, and compares against existing `core.json`._
...
> ```
>
> _Parses Peter Parker and writes the validated declarative JSON and updated audit metadata into `src/data/supplemental/pack/core.json`._

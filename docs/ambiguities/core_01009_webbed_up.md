...
# Card Ambiguity Report: Webbed Up (`01009`)

* **MarvelCDB Link:** [https://marvelcdb.com/card/01009](https://marvelcdb.com/card/01009)
* **Official Printed Text:** `Hero form only. Attach to an enemy. Max 1 per enemy.
Forced Interrupt: When attached enemy would attack, discard Webbed Up instead. Then, stun that enemy.`

---

## 🔍 Why Code-Level Implementation Audit (Step 6) Fails
1. **Effect primitive 'CANCEL_ATTACK_AND_STUN' is not implemented in src/engine/effects/index.ts.**

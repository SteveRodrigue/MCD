---
card_code: "01020"
card_name: "Hellcat (Patsy Walker)"
pack: "core"
...
# Card Ambiguity Report: Hellcat (Patsy Walker) (`01020`)

* **MarvelCDB Link:** [https://marvelcdb.com/card/01020](https://marvelcdb.com/card/01020)
* **Official Printed Text:** `Action: Return Hellcat to your hand.`

---

## 🔍 Why Code-Level Implementation Audit (Step 6) Fails
1. **Effect primitive 'RETURN_TO_HAND' is not implemented in src/engine/effects/index.ts.**

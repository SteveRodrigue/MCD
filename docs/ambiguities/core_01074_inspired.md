...
# Card Ambiguity Report: Inspired (`01074`)

* **MarvelCDB Link:** [https://marvelcdb.com/card/01074](https://marvelcdb.com/card/01074)
* **Official Printed Text:** `Attach to an ally. Max 1 per ally.
Attached ally gets +1 THW and +1 ATK.`

---

## 🔍 Why Code-Level Implementation Audit (Step 6) Fails
1. **Effect primitive 'ALLY_STAT_BUFF' is not implemented in src/engine/effects/index.ts.**

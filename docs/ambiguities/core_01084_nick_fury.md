...
1. **Card-Specific Primitive Anti-Pattern (ADR-0021): 'NICK_FURY_CHOICE' contains card name.**
2. **Effect primitive 'DISCARD_SELF' is not implemented in src/engine/effects/index.ts.**

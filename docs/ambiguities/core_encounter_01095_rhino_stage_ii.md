...
* **Official Printed Text:** `<b>When Revealed</b>: Search the encounter deck and discard pile for the Breakin' & Takin' side scheme and reveal it. Shuffle the encounter deck.`
...
3. **Current Confidence:** 80% (Tier 3 Gate Fired).

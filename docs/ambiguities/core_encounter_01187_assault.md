...
# Card Ambiguity Report: Assault (`01187`)

* **MarvelCDB Link:** [https://marvelcdb.com/card/01187](https://marvelcdb.com/card/01187)
...
1. **Effect primitive 'VILLAIN_ATTACKS' is not implemented in src/engine/effects/index.ts.**

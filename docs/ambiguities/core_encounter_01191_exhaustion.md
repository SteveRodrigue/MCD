...
# Card Ambiguity Report: Exhaustion (`01191`)

* **MarvelCDB Link:** [https://marvelcdb.com/card/01191](https://marvelcdb.com/card/01191)
...
1. **Effect primitive 'EXHAUST_CHARACTER' is not implemented in src/engine/effects/index.ts.**

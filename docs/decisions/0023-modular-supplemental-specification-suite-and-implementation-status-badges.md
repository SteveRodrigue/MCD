...
* `04_effects_combat_threat.md`: `DEAL_DAMAGE`, `REMOVE_THREAT`, `PLACE_THREAT`, keywords.
* `05_effects_zones_cards.md`: `DRAW_CARDS`, `MODIFY_HAND_SIZE`, `SEARCH_AND_DRAW`, `PLAY_FROM_ZONE`.
* `06_effects_status_economy.md`: `APPLY_STATUS`, `TOUGHNESS`, `RESOURCE_GENERATION`, `DOUBLE_RESOURCE`.
...
* `09_sequences_and_prompts.md`: `sequence: []` multi-action chaining, `PLAYER_CHOICE` Pop-Art modals.

...
Over time, modals, decision prompts, action pickers, and settings dialogs in _Marvel Champions Digital_ (MCD) evolved with disparate visual treatments:
...
This visual fragmentation compromised interface immersion and visual hierarchy. We need a coherent design system that unifies all gameplay, action, and utility dialogs under MCD's 1960s Comic Pop-Art visual identity (ADR-0004), while preserving the in-universe vintage newsprint style of _The Daily Bugle_.
...
1. **Option 1: Complete Monolithic Uniformity:** Force all modals (including _The Daily Bugle_ and _OptionsMenu_) into an identical yellow/black pop-art container.
2. **Option 2: 3-Tier Categorized Design System (Chosen):**
   ...
   - **Tier 2 (In-Universe Broadsheet Press):** _The Daily Bugle_ and _EndTurnConfirmationModal_ remain dedicated 1960s newsprint broadsheets (`font-serif`, woodblock mastheads, newsprint paper background).
   - **Tier 3 (Comic Bullpen Utility Worksheets):** Utility dialogs (_OptionsMenu_, _ReportProblemModal_, inspector modals) use `bg-comic-paper` base with dark navy/red bullpen headers and framed comic card sections instead of sterile white boxes.
...
- _The Daily Bugle_ retains its distinctive in-universe narrative flavor without interference.
...
- **Cons:** Destroys the unique charm of _The Daily Bugle_ broadsheet and makes simple settings menus overly noisy.
...
- **Pros:**
  ...
  - Completely protects _The Daily Bugle_ retro newsprint experience.

...
- [ ] **Remaining Core Player Card Issues:**
  ...
  - [x] **[Issue #23](https://github.com/SteveRodrigue/MCD/issues/23):** `feat(engine): Cross-player attachments & ownership (Combat Training 01057)` ([ADR-0068](decisions/0068-cross-player-attachments-and-card-ownership-invariants.md)) ✅ (Completed)

...
| `DISCARDED_COUNT`     | Number of cards discarded by previous or current step.                                                                                        | Discard steps / cost payment                                               | _Legal Practice_ (`01022`), _Repulsor Blast_ (`01031`)                      |
...
- `clamp.max`: Maximum upper bound (e.g. `15` for _Gamma Slam_, `10` for _Energy Channel_).
...
### A. Suffered Damage Clamped to 15 (_Gamma Slam_ `01021`)
...
### B. Energy Counters Multiplied by 2 Clamped to 10 (_Energy Channel_ `01019`)
...
### C. Hero ATK Dynamic Damage (_Counter-Punch_ `01077`)
